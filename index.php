    ...
    <body>
                ...
                <div class="col-md-4">
                    <div class="card m-3" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                <small><strong>By : </strong><?php echo $product['user_name'];?></small>
                            </p>
                            <p class="card-text">
        ...
        <?php } else { ?>
            <div class="text-center py-5">
                <h3 class="text-danger font-weight-bolder py-5">No Products Found Yet</h3>
            </div>
            <?php } ?>
